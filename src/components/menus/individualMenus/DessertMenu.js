...
function DessertMenu(props) {
    ...
    useEffect((props) => {
        ...
        .then(json =>  {
            ...
            const menuProducts = Object.keys(json.Products).map((key) => {
                if (json.Products[key].ProductType === "Dessert") {
    ...
    return(<>
        ...
        <i className="material-icons carryout-icon large">cake</i>
...
export default connect(mapStateToProps, mapDispatchToProps)(DessertMenu)